...
#입력 받을 정수의 개수를 입력 받고 입력 받은 정수들의 평균을 구하시오.(단, 입력 받을 정수의 개수가 음수일 경우 다시 물으시오.)
###선배님 이걸 append를 사용할려면
###list1=[]
###a=int(intput('정수를 입력하시오:'))
###list1.append(a) 이런식으로 10개를 써야하나요?
list1=list(map(int,input('정수 10개를 띄어쓰기를 하여 입력하시오: ').split()))
print(list1)
